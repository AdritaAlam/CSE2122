...
//Refactors duplicates file read and write logic into method;
...
//		Using try catch exception;
		...
		} catch (File_Not_FoundException e) {
...
//		Called getReader() function;
		getReader();

//              Check arguments

//		For one argument pass;

		if(args.length == 0) {

			System.out.println("Enter one argument");
		}
//      For multiple aurgument passes;
